    ...
    .map((item, index) => ({
      ...
      analysis: item && item.analysis && typeof item.analysis === 'object' ? {
        ...
        global: item.analysis.global && typeof item.analysis.global === 'object' ? {
          ...
          totalSemantic: cleanText(item.analysis.global.totalSemantic || item.analysis.global.detailedSummary, 1800),
          detailedSummary: cleanText(item.analysis.global.totalSemantic || item.analysis.global.detailedSummary, 1800),
