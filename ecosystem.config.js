  ...
  apps: [
    {
      ...
      env: {
        ...
        VIDEO_UPLOAD_MAX_MB: process.env.VIDEO_UPLOAD_MAX_MB || '102400',
        VIDEO_DIRECT_UPLOAD_TTL_MINUTES: process.env.VIDEO_DIRECT_UPLOAD_TTL_MINUTES || '30',
        VIDEO_DIRECT_UPLOAD_MAX_EXPIRES_SECONDS: process.env.VIDEO_DIRECT_UPLOAD_MAX_EXPIRES_SECONDS || '172800',
        ...
        UPLOAD_MAX_VIDEO_MB: process.env.UPLOAD_MAX_VIDEO_MB || '102400',
        VIDEO_API_FALLBACK_MAX_MB: process.env.VIDEO_API_FALLBACK_MAX_MB || '5120',
        DIRECT_VIDEO_MULTIPART_THRESHOLD_MB: process.env.DIRECT_VIDEO_MULTIPART_THRESHOLD_MB || '2048',
        DIRECT_VIDEO_PART_SIZE_MB: process.env.DIRECT_VIDEO_PART_SIZE_MB || '32',
        DIRECT_VIDEO_PROXY_PART_SIZE_MB: process.env.DIRECT_VIDEO_PROXY_PART_SIZE_MB || '8',
        DIRECT_VIDEO_PROXY_MAX_INFLIGHT: process.env.DIRECT_VIDEO_PROXY_MAX_INFLIGHT || '4',
        DIRECT_VIDEO_SESSION_TTL_MINUTES: process.env.DIRECT_VIDEO_SESSION_TTL_MINUTES || '180',
        DIRECT_VIDEO_SESSION_TTL_MAX_MINUTES: process.env.DIRECT_VIDEO_SESSION_TTL_MAX_MINUTES || '2880',
        DIRECT_VIDEO_ESTIMATED_BYTES_PER_SECOND: process.env.DIRECT_VIDEO_ESTIMATED_BYTES_PER_SECOND || '786432',
        DIRECT_VIDEO_FINISHING_BUFFER_SECONDS: process.env.DIRECT_VIDEO_FINISHING_BUFFER_SECONDS || '1800',
